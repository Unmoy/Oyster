      ...
      <section className="container-fluid home">
        <div className="row d-flex align-items-center">
          <div className="content col-md-12 col-lg-6">
            ...
            <p>
              Sign up <span className="header_span_3">FREE</span> for Oyster, a
              powerful, end-to-end AI-based platform that checks your writing
              for grammar errors, plagiarism.
            </p>
          </div>
